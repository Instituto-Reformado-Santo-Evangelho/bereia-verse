...
As configurações do aplicativo, histórico de visualização e notas (caso você não utilize a sincronização em nuvem) são armazenadas localmente no seu dispositivo. Você pode excluir esses dados a qualquer momento limpando o cache do aplicativo ou removendo as pastas de dados do sistema.

## 5. Compartilhamento com Terceiros
Nós **não vendemos, não trocamos e não compartilhamos** nenhuma informação com terceiros. A única interação externa ocorre entre o seu dispositivo e os servidores do Google, caso você opte por ativar a sincronização.

## 6. Alterações nesta Política
Reservamo-nos o direito de atualizar esta política de privacidade periodicamente. Recomendamos que você revise esta página ocasionalmente para se manter informado sobre como estamos protegendo suas informações.

## 7. Contato
Se você tiver alguma dúvida sobre esta política ou sobre o funcionamento do aplicativo, entre em contato conosco através do nosso site oficial: [tech.santoevangelho.com.br](https://tech.santoevangelho.com.br).

---
**Instituto Reformado Santo Evangelho (IRSE)**  
*Promovendo o acesso fiel às Escrituras através da tecnologia.*
