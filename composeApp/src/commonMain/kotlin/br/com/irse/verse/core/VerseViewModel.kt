...
class VerseViewModel(
    ...
    // Track original verses for history navigation (ignoring expansion)
    ...
    // Settings State delegated to Repository
        ...
        viewModelScope.launch {
             try {
                historyRepository.loadHistory()
                 ...
                 _errorState.value = "Erro ao atualizar histórico: ${e.message}"
             }
        }
    }
    ...
    fun updateLineHeight(height: Float) {
        viewModelScope.launch { settingsRepository.updateLineHeight(height) }
    }

    fun updateShowFireAnimation(enabled: Boolean) {
        viewModelScope.launch { settingsRepository.updateShowFireAnimation(enabled) }
    }
    ...
    fun captureSnapshot() {
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                _errorState.value = "Erro ao capturar imagem: ${e.message}"
