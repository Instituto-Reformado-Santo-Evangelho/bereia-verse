...
Write-Host "Instalando certificado na raiz confiavel..." -ForegroundColor Yellow
...
Write-Host "`nPara compilar o MSIX com este certificado:" -ForegroundColor Yellow
